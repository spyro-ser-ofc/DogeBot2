//-----(Doge Bot by 𝐒𝐤 Bot Inc.)-----\\
//-----(Youtube Channel: 𝐒𝐤)-----\\
//-----(Whatsapp number: +918590299146)-----\\
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*Sk Bot*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/G3a3AQndqS5J45eD7zznXF', "groupName": `𝐒𝐤 Bot Inc.`, "footerText": "*Sk Bot*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "Sk Bot"; break;
                case 1: jamss = "Sk Bot"; break;
                case 2: jamss = "Sk Bot"; break;
                case 3: jamss = "Sk Bot"; break;
                case 4: jamss = "Sk Bot"; break;
                case 5: jamss = "Sk Bot"; break;
                case 6: jamss = "Sk Bot"; break;
                case 7: jamss = "Sk Bot"; break;
                case 8: jamss = "Sk Bot"; break;
                case 9: jamss = "Sk Bot"; break;
                case 10: jamss = "Sk Bot"; break;
                case 11: jamss = "Sk Bot"; break;
                case 12: jamss = "Sk Bot"; break;
                case 13: jamss = "Sk Bot"; break;
                case 14: jamss = "Sk Bot"; break;
                case 15: jamss = "Sk Bot"; break;
                case 16: jamss = "Sk Bot"; break;
                case 17: jamss = "Sk Bot"; break;
                case 18: jamss = "Sk Bot"; break;
                case 19: jamss = "Sk Bot"; break;
                case 20: jamss = "Sk Bot"; break;
                case 21: jamss = "Sk Bot"; break;
                case 22: jamss = "Sk Bot"; break;
                case 23: jamss = "Sk Bot"; break;
            }
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hi ${pushname}, Sorry it seems at this time ${NamaOwner} is offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minute, ${heheh.seconds} Second\n\nPlease contact again after Online`, "*Sk Bot*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Sk Bot`,body:"𝐒𝐊 = 𝐒𝐄𝐑",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/918590299146?text=*💌🥰.sᴘʏʀᴏ.sᴇʀ.ʙɪɢ.ғᴇɴ💌🦋`}}})
		}
		const simir = (teks) => {
...
if (budy.startsWith('Alive')){
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*Sk Bot*", [{buttonId: 'igm', buttonText: {displayText: 'ɢɪᴛʜᴜʙ🔖'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'ɪɴsᴛᴀɢʀᴀᴍ💝'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('https://github.com/SKSER')
}
if(isButton == 'ytm'){
reply('https://instagram.com/salman.ski?utm_medium=copy_link')
}
...
tod = `🍻 ${z}𝑩𝒐𝒕 𝑵𝒂𝒎𝒆 : ${botName}${z}
🍻 ${z}𝑶𝒘𝒏𝒆𝒓 𝑵𝒂𝒎𝒆 : ${NamaOwner}${z}
🍻 ${z}𝑶𝒘𝒏𝒆𝒓 𝑵𝒖𝒎𝒃𝒆𝒓 : ${NomorOwner}${z}`
tod2 =`ʜɪ ${pushname} ʙʀᴏ ʜᴏᴡ ᴀʀᴇ ʏᴏᴜ?
...
await alpha.sendMessage(from, menuu, MessageType.buttonsMessage, {quoted: ftex})
	   ...
	   case 'searchmusic':
             case 'find':
if (!isGroup) return reply('type group')
if (isQuotedAudio){
const dlfile = await alpha.downloadMediaMessage(JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo)
...
.then(({data}) =>{
if (data.status){
reply(`*Sᴏɴɢ Fᴏᴜɴᴅᴇᴅ*\n\n\n• *ᴛɪᴛʟᴇ*: ${data.data.title}\n\n• *ᴀʀᴛɪsᴛs*: ${data.data.artists}\n\n• *ɢᴇɴᴇʀᴇ*: ${data.data.genre}\n\n• *ᴀʟʙᴜᴍ*: ${data.data.album}\n\n• *ʀᴇʟᴇsᴇ ᴅᴀᴛᴇ*: ${data.data.release_date}`)
...
break
              ...
              alpha.sendMessage(from, button, MessageType.listMessage)
          	break
case 'self':
          	if (!mek.key.fromMe && !isOwner) return reply('*ʙᴏᴛ ᴏᴡɴᴇʀ ᴏɴʟʏ ᴄᴀɴ ᴄʜᴀɴɢᴇ*')
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('The text?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`Sk Bot`}, MessageType.location)
...
break
      case "autojoin":
        ...
        if (args[0] == "on") {
          ...
          sendButMessage(from, `ONCE YOU ENABLE THIS FEATURE IN THE GROUP, BOT WILL AUTO JOIN ON SENDING GROUP LINK`, `ᴘʟᴇᴀsᴇ ᴄʜᴏᴏsᴇ ᴏɴᴇ`, [
            {
          ...
          reply('reply sticker/audio')
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY Sk Bot`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `Sk Bot`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `Sk Bot`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
...
ytmp4 => Video`, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`SEARCH: ${args[0]}`,body:"🔖YOUTUBE SEARCH",mediaType:"2",thumbnail:pporigi,mediaUrl:`https://youtu.be/B7DN5miMS3k`}}})
  ...
  ct = body.slice(9)
      ...
      case 'addbgm':
					...
					if (!isQuotedAudio) return reply('only audio')
					nm = body.slice(7)
					...
					alpha.sendMessage(from, `*sᴏɴɢ ᴀᴅᴅᴇᴅ ᴛᴏ ᴄʜᴇᴄᴋ* ${prefix}listvn`, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: 'status@broadcast' } : {})}, message: { orderMessage: { itemCount: 333, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `${nm}`, orderTitle: 'hehe', sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
					break
					 case 'delvn':
					...
					try {
					 ...
					 alpha.sendMessage(from, `*${nmm} ɪs ᴅᴇʟᴇᴛᴇᴅ*`, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: 'status@broadcast' } : {})}, message: { orderMessage: { itemCount: 59, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: '𝕯??𝖓𝖎𝕾', orderTitle: '𝕾𝖊𝖗', sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
					 } catch (err){
					console.log(err)
					reply(mess.error.api)
					}
