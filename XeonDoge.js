...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Sk Bot`,body:"𝐒𝐊 = 𝐒𝐄𝐑",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/380945798078?text=*💌🥰sᴋ.ᴅᴇᴠɪʟ.sᴇʀ.ʙɪɢ.ғᴇɴ💌🦋`}}})
		}
		const simir = (teks) => {
...
${z}༊ ${prefix}sᴏᴜɴᴅᴍᴇɴᴜ${z}

${z}༊ ${prefix}ʀᴇɴᴛʙᴏᴛ${z}

${z}༊ ${prefix}sᴛᴀᴛᴜs${z}

${z}༊ ${prefix}ɪɴᴛᴀᴋᴇᴍᴇɴᴜ${z}

${z}༊ ${prefix}ʀᴜɴᴛɪᴍᴇ${z}

${z}༊ ${prefix}ᴍᴀᴋᴇʀᴍᴇɴᴜ${z}

${z}༊ ${prefix}ᴏᴡɴᴇʀᴍᴇɴᴜ${z}

${z}༊ ${prefix}ɢʀᴏᴜᴘᴍᴇɴᴜ${z}

${z}༊ ${prefix}ᴏᴛʜᴇʀᴍᴇɴᴜ${z}

${z}༊ ${prefix}ᴅᴏᴡɴʟᴏᴀᴅᴍᴇɴᴜ${z}

${z}༊ ${prefix}ғᴜɴᴍᴇɴᴜ${z}

${z}༊ ${prefix}ɴsғᴡᴍᴇɴᴜ${z}

${z}༊ ${prefix}ᴀɴɪᴍᴇᴍᴇɴᴜ${z}
